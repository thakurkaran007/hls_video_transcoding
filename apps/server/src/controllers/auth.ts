...
function getSignedCookiesForBlob() {
  ...
  console.log("cdbnDistributionDomain:", cdnDistributionDomain);
  console.log("Using private key for signing cookies:", !!privateKey);
  ...
  console.log("Cookies generated:", cookiesResult);
